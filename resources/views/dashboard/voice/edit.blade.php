@extends('dashboard');
@section('body')
    <form class="needs-validation" method="POST" action="{{route('voice.update',$voice->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">update voice</h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-1">
                                <div class="col-md-4 col-12 mb-3 position-relative">
                                    ...
                                    <input type="text" class="form-control"  id="validationTooltip01" name="name"
                                           placeholder="name" value="{{$voice->name}}" required/>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 mb-1 mb-sm-0">
                                    ...
                                    <input class="form-control" name="voice_file" type="file" value="{{$voice->voice_file}}" id="voice_file"/>
                                </div>
